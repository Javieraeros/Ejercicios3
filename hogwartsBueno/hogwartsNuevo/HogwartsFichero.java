...
public class HogwartsFichero {
	...
	public static void main(String args[]) {
		...
		FicheroAlumno fichero = new FicheroAlumno();
		...
		do {
			...
			fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","Opci�n de men� " + opcionMenu);
		...
		case 1:
			...
			do {
				...
				if (numAlumnos < 0) {
					fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","El usuario ha introducido un n�mero inv�lido de alumnos: " + numAlumnos);
			...
			do {
				...
				do {
					...
					if (!nombreValido) {
						...
						fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","El usuario ha intentado introducir el siguiente nombre inv�lido: " + nombre);
				...
				do {
					...
					if (!apellidoValido) {
						...
						fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","El usuario ha intentado introducir el siguiente nombre inv�lido: " + apellido);
				...
				do {
					...
					if (nota < 0) {
						...
						fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","El usuario ha intentado introducir la siguiente nota no v�lida: " + nota);
		...
		while (opcionMenu != 0 && opcionSubMenu != 0) {
			...
			do {
				...
				if (opcionSubMenu < 0 || opcionSubMenu > 8){
					...
					fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","El usuario ha introducido la opci�n inv�lida: " + opcionSubMenu);
					
				}
			} while (opcionSubMenu < 0 || opcionSubMenu > 8);
			
			fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","El usuario ha introducido la opci�n v�lida: " + opcionSubMenu);
			...
			case 3:
				...
				if (ua.buscarAlumno(alumnos, a) == -1) {
					...
					fichero.escribeTexto("hogwartsBueno//hogwartsNuevo//Hogwarts.log","No se ha eliminado ning�n alumno");
